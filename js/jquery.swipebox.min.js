...
!function (a, b, c, d) {
    c.swipebox = function (e, f) {
        var g, h, i = {
            ...
            q = a.innerWidth ? a.innerWidth : c(a).width(), r = a.innerHeight ? a.innerHeight : c(a).height(), s = 0,
        ...
        j.settings = {}, c.swipebox.close = function () {
            ...
            init: function (a) {
                ...
                var a, b, d, e, f, g, h = this, i = !1, j = !1, l = 10, m = 50, n = {}, o = {},
                    p = c("#swipebox-top-bar, #swipebox-bottom-bar"), r = c("#swipebox-slider");
                ...
                var b = "", c = a.match(/watch\?v=([a-zA-Z0-9\-_]+)/), d = a.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/),
