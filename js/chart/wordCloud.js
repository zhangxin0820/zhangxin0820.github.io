define("echarts/chart/wordCloud", ["require", "./base", "zrender/shape/Text", "../layout/WordCloud", "../component/grid", "../component/dataRange", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
    ...
    return o.wordCloud = {
        ...
        type: o.CHART_TYPE_WORDCLOUD, refresh: function (e) {
            ...
            var t = e.itemStyle.normal.textStyle,
                ...
                n = this.parseCenter(this.zr, e.center), o = {
                    size: i,
            ...
            var a = this.series, o = a[t], s = o.name || "", h = o.data[i], m = [h, o], V = this.component.legend,
                d = V ? V.getColor(s) : this.zr.getColor(t), U = this.deepMerge(m, "itemStyle.normal") || {},
                p = this.deepMerge(m, "itemStyle.emphasis") || {}, c = this.getItemStyleColor(U.color, t, i, h) || d,
                u = this.getItemStyleColor(p.color, t, i, h) || ("string" == typeof c ? l.lift(c, -.2) : c), g = new n({
                    zlevel: o.zlevel,
                    z: o.z,
                    hoverable: !0,
    ...
    return t.prototype = {
        start: function () {
            ...
            var n = null, a = 0, o = 0, r = 0, s = -1, l = [], h = null, m = this.wordsdata, V = this.defaultOption,
                d = V.wordletype, U = V.size, p = this, c = new i({type: d.type, width: U[0], height: U[1]});
            ...
            if (!e.sprite) {
                var n = this.defaultOption.cw, a = this.defaultOption.ch, o = this.defaultOption.c,
                    r = this.defaultOption.ratio, s = this.defaultOption.cloudRadians;
                ...
                for (--i; ++i < V;) {
                    ...
                    if (e.rotate) {
                        var p = Math.sin(e.rotate * s), c = Math.cos(e.rotate * s), u = d * c, g = d * p, y = U * c,
                            b = U * p;
            ...
            function o(e) {
                ...
                var s, l, h;
                if (e.rotate) {
                    var m = Math.sin(e.rotate * g), V = Math.cos(e.rotate * g), y = t * V, b = t * m, f = r * V,
                        k = r * m;
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var e, t, i, o, r = this._valueTextList, s = r.length, l = this.getFont(this.dataRangeOption.textStyle),
                m = this._itemGroupLocation.x, V = this._itemGroupLocation.y, d = this.dataRangeOption.itemWidth,
                U = this.dataRangeOption.itemHeight, p = this.dataRangeOption.itemGap, c = h.getTextHeight("国", l);
            ...
            var t, i, o = this.getFont(this.dataRangeOption.textStyle), r = this._itemGroupLocation.x,
                ...
                V = h.getTextHeight("国", o), d = 10, U = !0;
            ...
            var e, t, i, n, a, r, s, l, m = this._calculableLocation.x, V = this._calculableLocation.y,
                d = this._calculableLocation.width, U = this._calculableLocation.height,
